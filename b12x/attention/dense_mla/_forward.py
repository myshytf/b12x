...
class DenseMlaForwardKernel:
    ...
    def kernel(
        ...
        # selected chunks (past any window start) evenly, so every launched
        # CTA scans about (selected_chunks - first_valid_chunk) / active_splits
        ...
        # planned capacity. Splits past the selected chunks stay empty and
        # publish -inf partials.
        scan_chunks = selected_chunks - first_valid_chunk
